...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <h2 data-aos="fade-up" data-aos-delay="400">Kami adalah desainer grafis yang menciptakan seni visual
                        yang inovatif.</h2>
    ...
    <main id="main">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h4 class="title"><a href="desain.php">Desain Grafis</a></h4>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h4 class="title"><a href="cetak.php">Percetakan</a></h4>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <h4 class="title"><a href="falah.php">Cetak Undangan</a></h4>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <h4 class="title"><a href="atk.php">Perlengkapan ATK</a></h4>
                            <p class="description">Menyediakan berbagai kebutuhan kantor seperti alat tulis dan kertas.
                            </p>
                        </div>
                    </div>
        ...
        <!-- Popular category -->
        <section id="services" class="popular-categories pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="popular-item">
                            ...
                            <div class="border-button">
                                <a href="https://wa.me/+6282233377661?text=Kak%20saya%20mau%20pesan%20Banner" target="_blank">Chat to
                                    Order</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="popular-item">
                            ...
                            <div class="border-button">
                                <a href="https://wa.me/+6282233377661?text=Kak%20saya%20mau%20pesan%20sablon%20kaos" target="_blank">Chat to
                                    Order</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="popular-item">
                            ...
                            <div class="border-button">
                                <a href="https://wa.me/+6282233377661?text=Kak%20saya%20mau%20pesan%20desain%20konten" target="_blank">Chat
                                    to Order</a>
                            </div>
                        </div>
                    </div>
        ...
        <section id="testimonials" class="testimonials section-bg">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>Testimonials</h2>
                    <p>Berikut adalah beberapa testimonial dari pelanggan kami</p>
                </div>
                            ...
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    ...
                                    <p>
                                        ...
                                        Saya sangat puas dengan layanan profesional dan hasil kerja yang luar biasa dari
                                        Ravaa Studio!.
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    ...
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Ravaa Studio benar-benar mengerti visi kami dan menghadirkan desain yang
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    ...
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Layanan percetakan yang cepat dan berkualitas tinggi. Terima kasih, Ravaa
                                        Studio!.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    ...
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Pelayanan service komputer yang handal dan terpercaya. Sangat direkomendasikan!
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    ...
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Ravaa Studio adalah mitra terbaik untuk semua kebutuhan desain dan percetakan
                                        kami.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
        ...
        <section id="portfolio" class="portfolio">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>Portfolio</h2>
                    <p>Portofolio kami mencerminkan beragam karya kreatif yang menggambarkan dedikasi kami dalam
                        menciptakan solusi desain yang unik.</p>
                </div>
                {{-- 
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-banner">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <div class="portfolio-links">
                                    <a href="assets/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Banner"><i class="bx bx-plus"></i></a>
