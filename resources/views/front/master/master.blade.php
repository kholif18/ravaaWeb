...
<head>
  ...
  <title>Ravaa Studio | @yield('title')</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('client/assets/img/favicon.ico') }}" rel="icon">
  <link href="{{ asset('client/assets/img/favicon.ico') }}" rel="apple-touch-icon">
